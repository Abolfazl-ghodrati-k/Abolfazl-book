import {
  ...
  SiSass,
  SiTailwindcss,
  // @ts-expect-error TS(2305): Module '"react-icons/si"' has no exported member '... Remove this comment to see the full error message
  SiMaterialui,
  SiVuedotjs,
  SiNuxtdotjs,
  SiExpress,
  ...
  return (
    <div className="w-full skills">
      <div className="stuff [&>*]:m-1 max-w-[596px]">
        ...
        <span className="stuff-1">
          {/* @ts-expect-error TS(2741): Property 'icon' is missing in type '{ fill: string... Remove this comment to see the full error message */}
